...
####This model has a random generation function on the length of X, rt(length(x)), a constant of 6, and a coefficient of 1.5 for X.  Basically, it's a linear regression model of y=1.5x + 6 + random. The random function has a big effect on the model. In just these 5 runs, my Y-intercept ranged from 5.74 to 7.32. 
